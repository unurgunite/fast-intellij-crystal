...
class CrystalTestConsolePropertiesTest : BasePlatformTestCase() {
    ...
    fun testConsoleFlags() {
        ...
        assertFalse(
            com.intellij.execution.testframework.sm.runner.SMTRunnerConsoleProperties.HIDE_PASSED_TESTS
                .value(props),
        )
        assertTrue(
            com.intellij.execution.testframework.sm.runner.SMTRunnerConsoleProperties.OPEN_FAILURE_LINE
                .value(props),
        )
        assertTrue(
            com.intellij.execution.testframework.TestConsoleProperties.SCROLL_TO_SOURCE
                .value(props),
        )
        assertTrue(
            com.intellij.execution.testframework.TestConsoleProperties.SELECT_FIRST_DEFECT
                .value(props),
        )
    }

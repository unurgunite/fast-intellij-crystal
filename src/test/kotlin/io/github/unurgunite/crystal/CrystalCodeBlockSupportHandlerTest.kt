...
class CrystalCodeBlockSupportHandlerTest : BasePlatformTestCase() {
     ...
     */
    private fun invoke(name: String, arg: IElementType? = null): TokenSet {
        val method = if (arg == null && name != "getDirectChildrenElementTypes") {
    ...
    private fun childrenOf(parentType: IElementType?): TokenSet =
        invoke("getDirectChildrenElementTypes", parentType)
    ...
    fun testTopLevelCoversAllBlockConstructs() {
        ...
        for (expected in listOf(
            ...
            CrystalTypes.BEGIN_STATEMENT, CrystalTypes.METHOD_DEFINITION,
            CrystalTypes.CLASS_DEFINITION, CrystalTypes.MODULE_DEFINITION,
            CrystalTypes.STRUCT_DEFINITION, CrystalTypes.ENUM_DEFINITION,
            CrystalTypes.ANNOTATION_DEFINITION, CrystalTypes.LIB_DEFINITION,
            CrystalTypes.MACRO_DEFINITION, CrystalTypes.BLOCK
        )) {
    ...
    fun testKeywordsCoverOpenMiddleAndClose() {
        val kw = keywords()
        for (expected in listOf(
            CrystalTypes.DEF, CrystalTypes.CLASS, CrystalTypes.DO,
            CrystalTypes.IF, CrystalTypes.END, CrystalTypes.ELSE,
            CrystalTypes.ELSIF, CrystalTypes.WHEN, CrystalTypes.RESCUE,
            CrystalTypes.ENSURE
        )) {
    ...
    fun testChildrenAreSubsetOfKeywords() {
        ...
        val structural = setOf(
            CrystalTypes.ELSIF_CLAUSE, CrystalTypes.ELSE_CLAUSE,
            CrystalTypes.RESCUE_CLAUSE, CrystalTypes.ENSURE_CLAUSE,
            CrystalTypes.WHEN_CLAUSE, CrystalTypes.IN_CLAUSE
        )

...
class CrystalNavigationItem(
    private val symbol: CrystalSymbol,
) : NavigationItem {
    ...
    override fun canNavigate(): Boolean = symbol.element is NavigationItem && (symbol.element as NavigationItem).canNavigate()

...
object CrystalTokenTypes {
    ...
    @JvmField val KEYWORDS =
        TokenSet.create(
            CrystalTypes.ABSTRACT,
            CrystalTypes.ALIAS,
            CrystalTypes.ANNOTATION,
            CrystalTypes.AS,
            CrystalTypes.AS_QUESTION,
            CrystalTypes.ASM,
            CrystalTypes.BEGIN,
            CrystalTypes.BREAK,
            CrystalTypes.CASE,
            ...
            CrystalTypes.IF,
            CrystalTypes.IN,
            CrystalTypes.INCLUDE,
            CrystalTypes.INSTANCE_SIZEOF,
            CrystalTypes.IS_A,
            CrystalTypes.LIB,
            CrystalTypes.MACRO,
            CrystalTypes.MODULE,
            CrystalTypes.NEXT,
            CrystalTypes.NIL,
            CrystalTypes.NIL_QUESTION,
            CrystalTypes.OF,
            CrystalTypes.OFFSETOF,
            CrystalTypes.OUT,
            CrystalTypes.POINTEROF,
            CrystalTypes.PREVIOUS_DEF,
            CrystalTypes.PRIVATE,
            CrystalTypes.PROTECTED,
            CrystalTypes.REQUIRE,
            CrystalTypes.RESCUE,
            CrystalTypes.RESPONDS_TO,
            CrystalTypes.RETURN,
            CrystalTypes.SELECT,
            CrystalTypes.SELF,
            CrystalTypes.SIZEOF,
    ...
    @JvmField val OPERATORS =
        TokenSet.create(
            ...
            CrystalTypes.DOUBLE_SLASH_ASSIGN,
            CrystalTypes.WRAP_PLUS_ASSIGN,
            CrystalTypes.WRAP_MINUS_ASSIGN,
            CrystalTypes.WRAP_STAR_ASSIGN,
            CrystalTypes.WRAP_DOUBLE_STAR_ASSIGN,

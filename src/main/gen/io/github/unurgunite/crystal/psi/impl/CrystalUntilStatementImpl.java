...
public class CrystalUntilStatementImpl extends ASTWrapperPsiElement implements CrystalUntilStatement {

  public CrystalUntilStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

...
public class CrystalRegexExpressionImpl extends ASTWrapperPsiElement implements CrystalRegexExpression {

  public CrystalRegexExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

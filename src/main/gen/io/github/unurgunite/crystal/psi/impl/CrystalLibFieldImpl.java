...
public class CrystalLibFieldImpl extends ASTWrapperPsiElement implements CrystalLibField {

  public CrystalLibFieldImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CrystalVisitor visitor) {
    visitor.visitLibField(this);
  }

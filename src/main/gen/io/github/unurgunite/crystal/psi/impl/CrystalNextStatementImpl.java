...
public class CrystalNextStatementImpl extends ASTWrapperPsiElement implements CrystalNextStatement {

  public CrystalNextStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

...
public class CrystalAsmExpressionImpl extends ASTWrapperPsiElement implements CrystalAsmExpression {

  public CrystalAsmExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<CrystalAsmOperand> getAsmOperandList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, CrystalAsmOperand.class);
  }

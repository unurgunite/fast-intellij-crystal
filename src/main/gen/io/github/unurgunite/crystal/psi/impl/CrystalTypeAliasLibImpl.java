...
public class CrystalTypeAliasLibImpl extends ASTWrapperPsiElement implements CrystalTypeAliasLib {

  public CrystalTypeAliasLibImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CrystalVisitor visitor) {
    visitor.visitTypeAliasLib(this);
  }

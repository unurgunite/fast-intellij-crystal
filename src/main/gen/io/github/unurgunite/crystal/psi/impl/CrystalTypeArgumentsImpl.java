...
public class CrystalTypeArgumentsImpl extends ASTWrapperPsiElement implements CrystalTypeArguments {

  public CrystalTypeArgumentsImpl(@NotNull ASTNode node) {
    super(node);
  }

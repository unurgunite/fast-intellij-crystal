...
public class CrystalMacroDefinitionOpenImpl extends CrystalStubbedMacroDefinitionImpl implements CrystalMacroDefinitionOpen {

  public CrystalMacroDefinitionOpenImpl(ASTNode node) {
    super(node);
  }

  public CrystalMacroDefinitionOpenImpl(CrystalMacroDefinitionStub stub, IStubElementType stubType) {
    super(stub, stubType);
  }

  public void accept(@NotNull CrystalVisitor visitor) {
    visitor.visitMacroDefinitionOpen(this);
  }

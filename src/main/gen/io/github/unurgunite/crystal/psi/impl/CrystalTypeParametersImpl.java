...
public class CrystalTypeParametersImpl extends ASTWrapperPsiElement implements CrystalTypeParameters {

  public CrystalTypeParametersImpl(@NotNull ASTNode node) {
    super(node);
  }

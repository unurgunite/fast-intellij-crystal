...
public class CrystalYieldExpressionImpl extends ASTWrapperPsiElement implements CrystalYieldExpression {

  public CrystalYieldExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

...
public class CrystalElsifClauseImpl extends ASTWrapperPsiElement implements CrystalElsifClause {

  public CrystalElsifClauseImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CrystalVisitor visitor) {
    visitor.visitElsifClause(this);
  }
  ...
  public CrystalCondition getCondition() {
    return notNullChild(PsiTreeUtil.getChildOfType(this, CrystalCondition.class));
  }

...
public class CrystalIncludeStatementImpl extends ASTWrapperPsiElement implements CrystalIncludeStatement {

  public CrystalIncludeStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

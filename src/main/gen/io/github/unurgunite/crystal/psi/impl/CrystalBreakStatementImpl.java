...
public class CrystalBreakStatementImpl extends ASTWrapperPsiElement implements CrystalBreakStatement {

  public CrystalBreakStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

...
public class CrystalCommandExpressionImpl extends ASTWrapperPsiElement implements CrystalCommandExpression {

  public CrystalCommandExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

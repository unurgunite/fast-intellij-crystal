...
public class CrystalGroupedExpressionImpl extends ASTWrapperPsiElement implements CrystalGroupedExpression {

  public CrystalGroupedExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

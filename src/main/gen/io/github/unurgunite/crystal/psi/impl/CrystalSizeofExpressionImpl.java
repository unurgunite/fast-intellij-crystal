...
public class CrystalSizeofExpressionImpl extends ASTWrapperPsiElement implements CrystalSizeofExpression {

  public CrystalSizeofExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

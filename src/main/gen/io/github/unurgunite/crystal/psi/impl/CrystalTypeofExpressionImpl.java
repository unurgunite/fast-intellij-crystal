...
public class CrystalTypeofExpressionImpl extends ASTWrapperPsiElement implements CrystalTypeofExpression {

  public CrystalTypeofExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

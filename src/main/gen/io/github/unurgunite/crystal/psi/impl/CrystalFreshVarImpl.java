...
public class CrystalFreshVarImpl extends CrystalVariableReferenceMixin implements CrystalFreshVar {

  public CrystalFreshVarImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CrystalVisitor visitor) {
    visitor.visitFreshVar(this);
  }

...
public class CrystalParameterListImpl extends ASTWrapperPsiElement implements CrystalParameterList {

  public CrystalParameterListImpl(@NotNull ASTNode node) {
    super(node);
  }

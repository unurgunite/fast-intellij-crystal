...
public class CrystalBareCommandSpaceFirstImpl extends CrystalMethodCallExpressionMixin implements CrystalBareCommandSpaceFirst {

  public CrystalBareCommandSpaceFirstImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CrystalVisitor visitor) {
    visitor.visitBareCommandSpaceFirst(this);
  }

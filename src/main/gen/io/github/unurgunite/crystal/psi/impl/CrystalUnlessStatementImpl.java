...
public class CrystalUnlessStatementImpl extends ASTWrapperPsiElement implements CrystalUnlessStatement {

  public CrystalUnlessStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

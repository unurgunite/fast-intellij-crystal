...
public class CrystalPropertyDeclarationImpl extends ASTWrapperPsiElement implements CrystalPropertyDeclaration {

  public CrystalPropertyDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }

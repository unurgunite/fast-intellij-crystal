...
public class CrystalExtendStatementImpl extends ASTWrapperPsiElement implements CrystalExtendStatement {

  public CrystalExtendStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

...
public class CrystalLibDefinitionImpl extends ASTWrapperPsiElement implements CrystalLibDefinition {

  public CrystalLibDefinitionImpl(@NotNull ASTNode node) {
    super(node);
  }

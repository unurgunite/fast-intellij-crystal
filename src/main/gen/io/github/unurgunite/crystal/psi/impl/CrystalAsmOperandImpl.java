...
public class CrystalAsmOperandImpl extends ASTWrapperPsiElement implements CrystalAsmOperand {

  public CrystalAsmOperandImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public CrystalStringExpression getStringExpression() {
    return notNullChild(PsiTreeUtil.getChildOfType(this, CrystalStringExpression.class));
  }

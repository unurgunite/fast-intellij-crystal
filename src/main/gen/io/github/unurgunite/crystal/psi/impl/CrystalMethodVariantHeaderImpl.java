...
public class CrystalMethodVariantHeaderImpl extends ASTWrapperPsiElement implements CrystalMethodVariantHeader {

  public CrystalMethodVariantHeaderImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CrystalVisitor visitor) {
    visitor.visitMethodVariantHeader(this);
  }
  ...
  public CrystalMacroControl getMacroControl() {
    return notNullChild(PsiTreeUtil.getChildOfType(this, CrystalMacroControl.class));
  }

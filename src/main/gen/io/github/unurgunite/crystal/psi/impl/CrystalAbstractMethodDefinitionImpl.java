...
public class CrystalAbstractMethodDefinitionImpl extends CrystalStubbedMethodDefinitionImpl implements CrystalAbstractMethodDefinition {

  public CrystalAbstractMethodDefinitionImpl(ASTNode node) {
    super(node);
  }

  public CrystalAbstractMethodDefinitionImpl(CrystalMethodDefinitionStub stub, IStubElementType stubType) {
    super(stub, stubType);
  }
